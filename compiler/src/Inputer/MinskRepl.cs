    ...
    internal sealed class MinskRepl : Repl
    {
        ...
        private void EvaluateLoad(string path)
        {
            ...
            if (!File.Exists(path))
            {
                ...
                Console.WriteLine($"Erro: arquivo não existe '{path}'");
                Console.ResetColor();
                return;
            }
        ...
        private void EvaluateDump(string functionName)
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine($"Erro: função '{functionName}' não existe");
                Console.ResetColor();
                return;
            }
        ...
        {
            string currentDirectory = "/Users/vagnerwentz/Projects/compiler/samples/hello";
            // Console.WriteLine("currentDirectory " + currentDirectory);
            string filePath = Path.Combine(currentDirectory, "hello.ms");
